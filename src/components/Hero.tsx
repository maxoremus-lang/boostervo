export default function Hero() {
  return (
    <section className="bg-bleu pt-24 pb-16 sm:pt-32 sm:pb-20 px-6 sm:px-10 lg:px-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-stretch lg:gap-12">
        {/* Colonne gauche — Texte */}
        <div className="flex flex-col justify-center lg:w-1/2 text-center lg:text-left text-white">
          ...
          <div className="animate-fade-up delay-300 border-l-4 border-orange bg-white/10 rounded-r-lg p-5 text-left mb-8">
