...
/**
 * Signup V5 — Clone de V4, base pour itérations.
...
import ThreeCasesRequestModal from "../_components/ThreeCasesRequestModal";

export default function SignupV5Page() {
  ...
  const buttons = (
    <div className="mt-6 flex flex-col gap-3">
      ...
      >
        ...
        Recevoir 3 cas clients par email
      </button>
    </div>
  );
