  ...
  return (
    <div className="pb-24">
      ...
      <div className="bg-bleu px-5 pt-6 pb-8 text-white">
        ...
        {/* Bascule vue bureau — visible uniquement sur grand écran */}
        <Link
          href="/app/desktop/rappels"
          className="hidden lg:inline-flex mt-3 items-center gap-1.5 text-[11px] font-semibold text-white/80 hover:text-white transition"
        >
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
          Passer à la vue bureau →
        </Link>
      </div>
