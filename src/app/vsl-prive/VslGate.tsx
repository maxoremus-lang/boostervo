    ...
    <div className="min-h-screen bg-bleu text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 pb-16">
        <div className="w-full max-w-3xl text-center">
          ...
          <div
            className={
              "relative w-full rounded-xl overflow-hidden shadow-2xl bg-black/40 border border-white/10 " +
              (unlocked ? "aspect-video" : "")
            }
          >
            {unlocked ? (
              <video
              ...
              <div className="flex items-center justify-center px-6 py-12 min-h-[340px]">
                <form onSubmit={handleSubmit} className="w-full max-w-sm">
                  ...
                  >
                    {submitting ? "Un instant…" : "Voir la vidéo"}
                  </button>
